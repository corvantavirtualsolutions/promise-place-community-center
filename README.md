...
Single-page marketing site for Promise Place Community Center, a community-based
...
app/
  ...
  page.js        Section order + JSON-LD structured data
...
components/
  ...
  Hero.js  About.js  Services.js  WhoWeServe.js
  SchoolBased.js  Insurance.js  Process.js
...
`components/FAQ.js`. Add, remove or reorder entries there.
